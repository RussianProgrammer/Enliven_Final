...
import sis.pewpew.R;
import sis.pewpew.adapters.AchievesRecyclerViewAdapter;
...
public class AchievementsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (!dialogShown) {
            ...
            achievementsFragmentWelcomeDialog.setMessage("В разделе \"Достижения\" Вы можете исследовать полученные награды. " +
                    "Каждый раз, открывая новое достижение, дата его получения регистрируется в Вашем аккаунте. " +
                    "Кроме того, коснувшись открытого достижения Вы также сможете прочесть краткую информацию о нем, " +
                    "а также узнать, сколько еще участников его разблокировало.");
                    ...
                    if (points >= 100) {
                        ...
                        if (achieve1Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("1").setValue(date);
                            }
                    ...
                    if (points >= 600) {
                        ...
                        if (achieve2Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("2").setValue(date);
                            }
                    ...
                    if (points >= 1100) {
                        ...
                        if (achieve3Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("3").setValue(date);
                            }
                    ...
                    if (points >= 1600) {
                        ...
                        if (achieve4Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("4").setValue(date);
                            }
                    ...
                    if (points >= 2100) {
                        ...
                        if (achieve5Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("5").setValue(date);
                            }
                    ...
                    if (points >= 2600) {
                        ...
                        if (achieve6Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("6").setValue(date);
                            }
                    ...
                    if (points >= 3100) {
                        ...
                        if (achieve7Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("7").setValue(date);
                            }
                    ...
                    if (points >= 3600) {
                        ...
                        if (achieve8Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("8").setValue(date);
                            }
                    ...
                    if (points >= 4100) {
                        ...
                        if (achieve9Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("9").setValue(date);
                            }
                    ...
                    if (points >= 4600) {
                        ...
                        if (achieve10Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("10").setValue(date);
                            }
                    ...
                    if (points >= 5100) {
                        ...
                        if (achieve11Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("11").setValue(date);
                            }
                    ...
                    if (points >= 5600) {
                        ...
                        if (achieve12Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("12").setValue(date);
                            }
                    ...
                    if (points >= 6100) {
                        ...
                        if (achieve13Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("13").setValue(date);
                            }
                    ...
                    if (points >= 6600) {
                        ...
                        if (achieve14Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("14").setValue(date);
                            }
                    ...
                    if (points >= 7100) {
                        ...
                        if (achieve15Gotten) {
                            if (!user.isAnonymous()) {
                                ...
                                mDatabase.child("demos").child(user.getUid()).child("achievements").child("15").setValue(date);
                            }
